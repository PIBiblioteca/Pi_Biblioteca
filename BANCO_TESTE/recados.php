    ...
    <a class="logo"id="logo" href="">FATEC</a>
      <nav id="nav">
        ...
        <ul id="menu" role="menu">
          ...
          <li><a class="destaque" href="http://localhost:8080/GitHub/Pi_Biblioteca/BANCO_TESTE/recados.php">Recados</a></li>
        ...
        <tbody> 
            ...
            if ($conn->num_rows > 0){
              while ($dado = $conn->fetch_assoc()){    
                ?>
                    <tr class="dados">
                    <td> <?php echo $dado['id_recado']; ?> </td>
                    <td> <?php echo $dado['recado']; ?> </td>

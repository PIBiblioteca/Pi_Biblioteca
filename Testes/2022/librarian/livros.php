...
<<<<<<< HEAD:bibliotecaria/livros.php
include "../bibliotecaria/componentes_funcoes/connection.php";
include "../bibliotecaria/componentes_funcoes/header.php";
=======
include "connection.php";
include "header.php";
>>>>>>> parent of 813f659 (Tela "sig_biblioteca" criada; BD de livros oficial importado; Pastas do sistema organizadas.):Testes/2022/librarian/livros.php
?>
...
=======
                    <?php include "botao_pesquisar.php";//BOTÃO PESQUISAR?> 
>>>>>>> parent of 813f659 (Tela "sig_biblioteca" criada; BD de livros oficial importado; Pastas do sistema organizadas.):Testes/2022/librarian/livros.php
                </div>

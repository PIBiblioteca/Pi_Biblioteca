...
<<<<<<< HEAD:bibliotecaria/retiradas.php
include "../componentes_funcoes/header.php";
include "../componentes_funcoes/connection.php"
=======
include "header.php";
include "connection.php"
>>>>>>> parent of 813f659 (Tela "sig_biblioteca" criada; BD de livros oficial importado; Pastas do sistema organizadas.):Testes/2022/librarian/retiradas.php
?>

  ...
  <div class="wrapper">
    ...
    <header>
      <div class="netflixLogo">
        <a id="logo" href="#home"><img src="../images/logo_bibliofateca.png" alt=""style="height: 25px; padding-bottom: 16px" alt="Logo Image"></a>
      </div>      
      <nav class="main-nav">                
        <a href="#home">Home</a>
        <a href="#tvShows">Meus empréstimos</a>
        <a href="#movies">Regras de uso </a>
        <a href="#originals">Artigos</a>
    ...
    <section class="main-container" >
      ...
      <h1 id="home">Livros Disponíveis</h1>
          <div class="box">
    ...
    <!-- BD BIBLIOFATECA -->
      ...
      ?>
      <!-- style="height: 160px;" -->
      <a href="../usuario/solicitar_emprestimo.php?id_livro=<?php echo $row["id_livro"]; ?>"><img src="../images/CAPA NÃO cARREGADA.jpg" alt=""></a>
      
      <a style="color: white; text-decoration: none;" href="../usuario/solicitar_emprestimo.php?id_livro=<?php echo $row["id_livro"]; ?>"> <?php echo $row["titulo_livro"]; ?> 
    
      <?php echo "<br> Disponíveis: " .$row["quantidade_livro"];  ?>
      </a>
      <?php } ?>

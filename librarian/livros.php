        ...
        <div class="right_col" role="main">
            <div class="">
                <div class="page-title">
                    ...
                    <?php include "../librarian/componentes_funcoes/botao_pesquisar.php";//BOTÃO PESQUISAR?> 
                </div>
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                            <a href="../librarian/componentes_funcoes/adicionar_livros.php"><i class="fa fa-edit"></i> Adicionar livro <span class="fa fa-chevron-down"></span></a>
                                <?php 
